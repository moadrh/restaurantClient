...
import { ServeurService } from '../personne/serveur.service';

@Component({
  selector: 'app-Table-service-service',
...
export class TableServiceComponent implements OnInit {
  ...
  constructor(private tableServeurService: TableServiceService,private tableService: TableService,
